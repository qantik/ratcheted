...
powerful as a high-end smartphone.
...
\begin{figure}[H]
  ...
  \begin{subfigure}[t]{0.32\linewidth}
    ...
    \caption{}
  \end{subfigure}
  \caption{Message Traffic Pictographs; Alternating Traffic (a), Unidirectional
...
\item \textbf{AES-GCM.} As the authenticated encryption scheme with
  associated-data used in the FS-AEAD scheme in \cite{alwen2018double}.
  AES-GCM is part of the Go standard
...
\item \textbf{ECDSA.} As the signature scheme in protocols where
