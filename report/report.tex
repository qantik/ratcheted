...
usual correctness notions. The protocol further needs a forward secure
signature scheme (\texttt{DS.Gen,DS.Sign,DS.Verify}) and a random
oracle \texttt{H}.
...
\item \textbf{Init.} The initialization routine creates two sets of key pairs
  ...
  of all received ciphertexts and finally an array $TR$ for acccumulating
...
\item \textbf{Send.} The send operation starts of with creating two signature
  ...
  necessary to provide post-hijack security while maintaining post-compromise
