...
primitives in this and the following protocol.
...
key update algorithms and is the principal tool with with the
...
ku-KEM and Signature keys. If some messages are delay such
...
% % Put into separate section
% The whole codebase with all the protocols, the accompanying benchmarks,
% auxiliary primitives and installation instructions is
% open-source \footnote{\url{https://github.com/qantik/ratcheted/}}
% and be freely altered.
