...
\begin{minipage}{.5\linewidth}
  {\fontsize{8}{10}\selectfont
    ...
    \State $(sk_\t{S},pk_\t{S}) \gets$ \Call{PKE.Gen}{}
    \State $(sk_\t{R},pk_\t{R}) \gets$ \Call{DS.Gen}{}
    ...
    \State $pt' \gets$ \Call{Dec}{$sk_\t{R},pk_\t{S},ad,ct$}
    \If{$pt' = \perp$}
...
\begin{minipage}{.5\linewidth}
  ...
  \begin{algorithmic}[1]
    ...
    \If{$\t{flag} = \t{true}$}
    \State $(sk_\t{S}',pk_\t{S}') \gets$ \Call{SC.Gen}{}
    \State $(\t{sk}_\t{R}',\t{pk}_\t{R}') \gets$ \Call{SC.Gen}{}
    ...
    \State $ct \gets$ \Call{Enc}{$sk_\t{S},pk_\t{R}, ad, pt'$}
