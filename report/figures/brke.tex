...
\begin{minipage}{0.5\linewidth}
  ...
  \begin{algorithmic}[1]
    ...
    \State $(sk_\t{u},pk_\t{u}) \gets$ \Call{\texttt{KEM.Gen}}{}
    ...
    \EndFor
    \State $\sigma \gets$ \Call{\texttt{sgn}}{$sgk,ad||C$}
    ...
    \State $pk \gets$ \Call{\texttt{KEM.Gen}}{$sk$}
...
\begin{minipage}{0.5\linewidth}
  ...
  \begin{algorithmic}[1]
    ...
    \For{$s' \gets r+1$  to $s$}
    \State $pk^* \gets$ \Call{\texttt{KEM.UpdPk}}{$pk^*,L\t{S}[s']$}
    \EndFor
    ...
    \State $c||C \gets C$
    \State $k \gets$ \Call{\texttt{KEM.Dec}}{$SK[e'],c$}
    \State $k^* \gets k^* ||k$
    \EndFor
    ...
    \State $SK[e'] \gets$ \Call{\texttt{KEM.UpdSk}}{$SK[e'],t^*$}
    \EndFor
